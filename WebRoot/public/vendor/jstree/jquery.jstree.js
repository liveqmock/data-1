	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' +
				...
				'.jstree ins { cursor: pointer; display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; } ' +
				'.jstree a { display:inline-block; line-height:16px; height:16px; color:white; white-space:nowrap; text-decoration:none; padding:5px 15px; margin:5px 0 0; cursor: pointer; } ' +
